...
<i>
Я — технический писатель с опытом разработки документации с нуля по требованиям ГОСТ и требованиям заказчика. Я создаю и актуализирую пользовательскую документацию, работаю с готовыми текстами - вычитка и правка.
</i>
<br />
<br />
...
### Сертификаты:
[Сертифика участника Первой Международной конференции технических писателей](https://disk.yandex.ru/i/-PFLKzAIKZrGiQ)
